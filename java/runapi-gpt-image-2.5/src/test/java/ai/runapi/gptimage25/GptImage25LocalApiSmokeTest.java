...
import ai.runapi.gptimage25.types.TextToImageResponse;
    ...
    class GptImage25LocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/gpt_image_2_5/text_to_image", this::handleRequest);
        server.start();
      }
      ...
      void runUsesApacheTransportAgainstLocalApi() throws Exception {
        try (GptImage25Client client =
            GptImage25Client.builder()
                .apiKey("sk-test")
      ...
      CompletedTextToImageResponse response =
        ...
        assertEquals("/api/v1/gpt_image_2_5/text_to_image", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/gpt_image_2_5/text_to_image/task_local_123", captured.path);
