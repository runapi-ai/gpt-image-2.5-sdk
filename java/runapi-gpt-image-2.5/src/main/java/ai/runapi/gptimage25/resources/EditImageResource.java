package ai.runapi.gptimage25.resources;
...
public final class EditImageResource extends Gptimage25Resource {
  /** API endpoint path for edit image operations. */
  public static final String ENDPOINT = "/api/v1/gpt_image_2_5/edit_image";
